...
| [**Automated JML W/ Cert-Based AuthN**](https://github.com/EvanHYearwood/jml-automation-lab) | Video & Screenshots Included | This lab automates the JML lifecycle between Active Directory and Okta using RSA-signed JWTs for secure API communication.| AD · Okta PowerShell · OAuth 2.0 · RSA · JWT| ![Queued](https://img.shields.io/badge/In_Progress-Active-e3a008?style=flat-square) |
