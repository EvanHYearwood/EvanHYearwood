...
| **Hybrid Identity Setup: On Prem AD -> Entra ID Sync + Conditional Access** ||My JML project above proves my ability to automate WITHIN a system. This project demonstrates understanding of how identity systems connect to each other.| Active Directory · Entra ID · Entra Connect · Conditional Access · MFA | ![Queued](https://img.shields.io/badge/Queued-888888?style=flat-square) |
